...
class _$DartRecord extends DartRecord {
  ...
  _$DartRecord._({this.id, this.title, this.answer, this.ffRef}) : super._();
...
class DartRecordBuilder implements Builder<DartRecord, DartRecordBuilder> {
  ...
  DartRecordBuilder() {
    DartRecord._initializeBuilder(this);
  }
  ...
  _$DartRecord _build() {
    final _$result = _$v ??
        new _$DartRecord._(id: id, title: title, answer: answer, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
